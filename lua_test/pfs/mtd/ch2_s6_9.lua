...
-- @file   mtd/ch2_s6_9.lua
-- @brief  mtd.mkvol ubifs (2.6.9)
-- @history 修改历史
--  \n 2026 创建文件
--]]
...
function M.run(...)
	...
	local work, err = mtd_common.setup_work("2.6.9")
	if work == nil then
	...
	local rc, msg = mtd.mkvol(path, { fs = "ubifs", src = tree })
	if rc ~= 0 then
