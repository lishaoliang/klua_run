...
-- @file   mtd/ch2_s6_14.lua
-- @brief  mtd.mkvol yaffs (2.6.14)
-- @history 修改历史
--  \n 2026 创建文件
--]]
...
function M.run(...)
	...
	local work, err = mtd_common.setup_work("2.6.14")
	if work == nil then
	...
	local rc, msg = mtd.mkvol(path, { fs = "yaffs2", src = tree })
	if rc ~= 0 then
