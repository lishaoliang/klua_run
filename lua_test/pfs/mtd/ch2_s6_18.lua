...
-- @file   mtd/ch2_s6_18.lua
-- @brief  mtd.mkvol cramfs 空树 (2.6.18)
-- @history 修改历史
--  \n 2026 创建文件
--]]
...
function M.run(...)
	...
	local work, err = mtd_common.setup_work("2.6.18")
	if work == nil then
	...
	local rc, msg = mtd.mkvol(path, { fs = "cramfs", src = tree })
	if rc ~= 0 then
