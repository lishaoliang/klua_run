...
M['global'] = {
	["shwnd"] = {
		...
		["/klbui/combo-menu"] = {
			...
			["height_max"] = 362,
			["item.background-color"] = {255, 236, 233, 216},
			["item.background-color:focus"] = {255, 236, 233, 216},
			["item.border-color"] = {255, 49, 106, 197},
			["item.border-color:focus"] = {255, 49, 106, 197},
			["item.color"] = {255, 0, 0, 0},
			["item.color:focus"] = {255, 0, 0, 0},
			...
			["padding-left"] = 2,
			["padding-right"] = 2,
			["vscrollbar.background-color"] = {255, 236, 233, 216},
			["vscrollbar.background-color:focus"] = {255, 236, 233, 216},
			["vscrollbar.border-color"] = {255, 0, 0, 0},
			["vscrollbar.border-color:focus"] = {255, 0, 0, 0},
			["vscrollbar-button.background-color"] = {255, 236, 233, 216},
			["vscrollbar-button.background-color:focus"] = {255, 236, 233, 216},
			["vscrollbar-button.color"] = {255, 127, 157, 185},
			["vscrollbar-button.color:focus"] = {255, 172, 168, 153},
			["vscrollbar.color"] = {255, 0, 0, 0},
			["vscrollbar.color:focus"] = {255, 0, 0, 0},
			["vscrollbar_w"] = 20,
		},
		["/klbui/decimal-menu"] = {
			["background-color"] = {255, 236, 233, 216},
			["border-color"] = {255, 192, 192, 192},
