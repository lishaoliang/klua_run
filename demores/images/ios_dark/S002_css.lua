...
M['global'] = {
	["shwnd"] = {
		...
		["/klbui/combo-menu"] = {
			...
			["height_max"] = 362,
			["item.background-color"] = {255, 28, 28, 30},
			["item.background-color:focus"] = {255, 28, 28, 30},
			["item.border-color"] = {255, 10, 132, 255},
			["item.border-color:focus"] = {255, 10, 132, 255},
			...
			["padding-left"] = 2,
			["padding-right"] = 2,
			["vscrollbar.background-color"] = {255, 28, 28, 30},
			["vscrollbar.background-color:focus"] = {255, 28, 28, 30},
			["vscrollbar.border-color"] = {255, 255, 255, 255},
			["vscrollbar.border-color:focus"] = {255, 255, 255, 255},
			["vscrollbar-button.background-color"] = {255, 28, 28, 30},
			["vscrollbar-button.background-color:focus"] = {255, 28, 28, 30},
			["vscrollbar-button.color"] = {255, 56, 56, 58},
			["vscrollbar-button.color:focus"] = {255, 142, 142, 147},
		...
		["/klbui/decimal-menu"] = {
			...
			["font-size"] = font_size_M,
			["string.background-color"] = {255, 44, 44, 46},
		},
