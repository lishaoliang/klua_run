...
local M = {
    ...
    -- lua test 1.4.3
    ['KpictureHint'] = '1.4.3 kpicture 選圖; 左示意圖自適應, 左右同圖',
    ...
    -- lua test 1.3.1
    ['KdialogHint'] = '1.3.1 kdialog 標題/值',
    ...
    -- lua test 1.3.2
    ['KviewHint'] = '1.3.2 kview 標題/底色/隱藏',
    ...
    ['Item2'] = '項2',
    ['Item3'] = '項3',
    ['KmenuHint'] = '1.3.4 kmenu 追加/變更',
    ['KmenuLabFmt'] = 'kmenu 值=%s',
    ['KmenuGetFmt'] = 'get value=%s',

    -- lua test 1.3.5
    ['KdivHint'] = '1.3.5 kdiv 標題/序號/隱藏',
    ...
    -- lua test 1.3.6
    ['KmodalHint'] = '1.3.6 modal 疊層',
    ['KmodalLabFmt'] = 'modal 數=%s',
    ['KmodalTitle'] = '模態',
    ['KmodalBody'] = '疊層',

    -- lua test 1.3.7
    ['KpopupHint'] = '1.3.7 popup 選單',
