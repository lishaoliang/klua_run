...
local M = {
    ...
    -- lua test 1.4.3
    ['KpictureHint'] = '1.4.3 kpicture 选图; 左示意图自适应, 左右同图',
    ...
    -- lua test 1.3.1
    ['KdialogHint'] = '1.3.1 kdialog 标题/值',
    ...
    -- lua test 1.3.2
    ['KviewHint'] = '1.3.2 kview 标题/底色/隐藏',
    ...
    ['Item2'] = '项2',
    ['Item3'] = '项3',
    ['KmenuHint'] = '1.3.4 kmenu 追加/变更',
    ['KmenuLabFmt'] = 'kmenu 值=%s',
    ['KmenuGetFmt'] = 'get value=%s',

    -- lua test 1.3.5
    ['KdivHint'] = '1.3.5 kdiv 标题/序号/隐藏',
    ...
    -- lua test 1.3.6
    ['KmodalHint'] = '1.3.6 modal 叠层',
    ['KmodalLabFmt'] = 'modal 数=%s',
    ['KmodalTitle'] = '模态',
    ['KmodalBody'] = '叠层',

    -- lua test 1.3.7
    ['KpopupHint'] = '1.3.7 popup 菜单',
